...
<div class="container-fluid">
    <div class="mb-4">
        <h1 class="h3 mb-0">Tambah Tarif</h1>
        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Form Tarif Baru</h5>
                </div>
                <div class="card-body">
                    @if(session('error'))
                    ...
                    <form action="{{ route('tarif.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama_tarif" class="form-control @error('nama_tarif') is-invalid @enderror" value="{{ old('nama_tarif') }}" required>
                                @error('nama_tarif')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                @error('program_studi_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Kosongkan jika berlaku untuk semua prodi</small>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="periode" class="form-select @error('periode') is-invalid @enderror" required>
                                    @foreach(\App\Models\Tarif::PERIODE as $key => $label)
                                        <option value="{{ $key }}" {{ old('periode', 'Semester') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('periode')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="nominal" class="form-control @error('nominal') is-invalid @enderror" value="{{ old('nominal') }}" min="0" required>
                                </div>
                                @error('nominal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
