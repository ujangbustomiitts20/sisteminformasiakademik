...
@section('title', 'Edit Riwayat Pendidikan - ' . $dosen->nama)
...
<div class="card">
    <div class="card-header">
        <i class="bi bi-mortarboard me-2"></i>Edit Riwayat Pendidikan - {{ $dosen->nama }}
    </div>
    <div class="card-body">
        <form action="{{ route('kepegawaian.pendidikan.update', [$dosen, $pendidikan]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="jenjang" id="jenjang" class="form-select @error('jenjang') is-invalid @enderror" required>
                            ...
                            @foreach(['D3', 'D4', 'S1', 'S2', 'S3', 'Profesi', 'Spesialis'] as $j)
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="program_studi" id="program_studi" class="form-control @error('program_studi') is-invalid @enderror" value="{{ old('program_studi', $pendidikan->program_studi) }}" required>
                        @error('program_studi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" name="tahun_masuk" id="tahun_masuk" class="form-control @error('tahun_masuk') is-invalid @enderror" value="{{ old('tahun_masuk', $pendidikan->tahun_masuk) }}" min="1950" max="{{ date('Y') }}">
                        @error('tahun_masuk')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" name="tahun_lulus" id="tahun_lulus" class="form-control @error('tahun_lulus') is-invalid @enderror" value="{{ old('tahun_lulus', $pendidikan->tahun_lulus) }}" required min="1950" max="{{ date('Y') }}">
                        @error('tahun_lulus')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_ijazah" id="tanggal_ijazah" class="form-control @error('tanggal_ijazah') is-invalid @enderror" value="{{ old('tanggal_ijazah', $pendidikan->tanggal_ijazah?->format('Y-m-d')) }}">
            ...
            <div class="mb-3">
                ...
                <textarea name="judul_tugas_akhir" id="judul_tugas_akhir" class="form-control @error('judul_tugas_akhir') is-invalid @enderror" rows="2">{{ old('judul_tugas_akhir', $pendidikan->judul_tugas_akhir) }}</textarea>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="mb-2">
                            <a href="{{ Storage::url($pendidikan->file_ijazah) }}" target="_blank" class="btn btn-outline-info btn-sm">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="mb-2">
                            <a href="{{ Storage::url($pendidikan->file_transkrip) }}" target="_blank" class="btn btn-outline-info btn-sm">
                                <i class="bi bi-file-earmark-text me-1"></i>Lihat File Saat Ini
                            </a>
                        </div>
                        @endif
