...
@section('title', 'Tambah Riwayat Pangkat - ' . $dosen->nama)
...
<div class="card">
    <div class="card-header">
        <i class="bi bi-award me-2"></i>Form Riwayat Pangkat/Golongan - {{ $dosen->nama }}
    </div>
    <div class="card-body">
        <form action="{{ route('kepegawaian.pangkat.store', $dosen) }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="pangkat" id="pangkat" class="form-select @error('pangkat') is-invalid @enderror" required>
                            ...
                            <option value="Penata Muda Tk. I" {{ old('pangkat') == 'Penata Muda Tk. I' ? 'selected' : '' }}>Penata Muda Tk. I</option>
                            <option value="Penata" {{ old('pangkat') == 'Penata' ? 'selected' : '' }}>Penata</option>
                            <option value="Penata Tk. I" {{ old('pangkat') == 'Penata Tk. I' ? 'selected' : '' }}>Penata Tk. I</option>
                            <option value="Pembina" {{ old('pangkat') == 'Pembina' ? 'selected' : '' }}>Pembina</option>
                            <option value="Pembina Tk. I" {{ old('pangkat') == 'Pembina Tk. I' ? 'selected' : '' }}>Pembina Tk. I</option>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="masa_kerja_tahun" id="masa_kerja_tahun" class="form-control @error('masa_kerja_tahun') is-invalid @enderror" value="{{ old('masa_kerja_tahun') }}" min="0">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="masa_kerja_bulan" id="masa_kerja_bulan" class="form-control @error('masa_kerja_bulan') is-invalid @enderror" value="{{ old('masa_kerja_bulan') }}" min="0" max="12">
