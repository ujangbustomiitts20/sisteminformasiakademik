...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('kepegawaian.pegawai.riwayat.jabatan.update', [$pegawai, $jabatan]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select name="jenis_jabatan" id="jenis_jabatan" class="form-select @error('jenis_jabatan') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $j }}" {{ old('jenis_jabatan', $jabatan->jenis_jabatan) == $j ? 'selected' : '' }}>{{ $j }}</option>
                                    @endforeach
                                </select>
                                @error('jenis_jabatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="unit_kerja" id="unit_kerja" class="form-control @error('unit_kerja') is-invalid @enderror" value="{{ old('unit_kerja', $jabatan->unit_kerja) }}">
                        @error('unit_kerja')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="tmt_jabatan" id="tmt_jabatan" class="form-control @error('tmt_jabatan') is-invalid @enderror" value="{{ old('tmt_jabatan', $jabatan->tmt_jabatan) }}" required>
                                @error('tmt_jabatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="tmt_selesai" id="tmt_selesai" class="form-control @error('tmt_selesai') is-invalid @enderror" value="{{ old('tmt_selesai', $jabatan->tmt_selesai) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="no_sk" id="no_sk" class="form-control @error('no_sk') is-invalid @enderror" value="{{ old('no_sk', $jabatan->no_sk) }}">
                                @error('no_sk')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="tanggal_sk" id="tanggal_sk" class="form-control @error('tanggal_sk') is-invalid @enderror" value="{{ old('tanggal_sk', $jabatan->tanggal_sk) }}">
                                @error('tanggal_sk')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pejabat_sk" id="pejabat_sk" class="form-control @error('pejabat_sk') is-invalid @enderror" value="{{ old('pejabat_sk', $jabatan->pejabat_sk) }}">
                        @error('pejabat_sk')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($jabatan->file_sk)
                        <div class="mb-2">
                            <a href="{{ asset('storage/'.$jabatan->file_sk) }}" target="_blank" class="btn btn-sm btn-outline-info">
