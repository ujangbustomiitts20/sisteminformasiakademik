...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ isset($fasilitas) ? route('pmb.konten-pmb.fasilitas.update', $fasilitas->hashid) : route('pmb.konten-pmb.fasilitas.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @if(isset($fasilitas))
                @method('PUT')
                @endif
