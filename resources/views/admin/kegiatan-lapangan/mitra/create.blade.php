...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Tambah Mitra Kegiatan</h1>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('admin.kegiatan-lapangan.mitra.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jabatan_kontak" class="form-control @error('jabatan_kontak') is-invalid @enderror" value="{{ old('jabatan_kontak') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="kuota_mahasiswa" class="form-control @error('kuota_mahasiswa') is-invalid @enderror" value="{{ old('kuota_mahasiswa', 10) }}" min="1">
