...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">{{ isset($mitra) ? 'Edit Mitra Kegiatan' : 'Tambah Mitra Kegiatan' }}</h1>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ isset($mitra) ? route('admin.kegiatan-lapangan.mitra.update', $mitra->hashid) : route('admin.kegiatan-lapangan.mitra.store') }}" method="POST">
                @csrf
                @if(isset($mitra))
                    @method('PUT')
                @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="kuota_mahasiswa" class="form-control @error('kuota_mahasiswa') is-invalid @enderror" value="{{ old('kuota_mahasiswa', $mitra->kuota_mahasiswa ?? 10) }}" min="1">
                            @error('kuota_mahasiswa')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" name="is_active" class="form-check-input" value="1" {{ old('is_active', $mitra->is_active ?? true) ? 'checked' : '' }}>
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> {{ isset($mitra) ? 'Update' : 'Simpan' }}
                    </button>
                </div>
            </form>
        </div>
