...
@section('content')
    ...
    <div style="text-align: justify; line-height: 1.8;">
        <p style="margin-bottom: 15px;">Yang bertanda tangan di bawah ini, {{ $config->jabatan_ttd ?? 'Kepala Bagian Akademik' }} {{ setting('nama_institusi', 'Universitas') }}, dengan ini menerangkan bahwa:</p>
        ...
        <p style="margin-bottom: 15px;">Adalah <strong>benar</strong> sebagai Mahasiswa aktif pada {{ setting('nama_institusi', 'Universitas') }} sampai dengan saat surat ini diterbitkan.</p>
