...
<div class="card">
    <div class="card-header">
        <i class="bi bi-plus-lg me-2"></i>Form Tambah Mata Kuliah
    </div>
    <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" name="jumlah_pertemuan" id="jumlah_pertemuan" class="form-control @error('jumlah_pertemuan') is-invalid @enderror" 
                                    value="{{ old('jumlah_pertemuan', 16) }}" min="1" max="32" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-3">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis" id="jenis_wajib" value="Wajib" {{ old('jenis', 'Wajib') == 'Wajib' ? 'checked' : '' }}>
                                <label class="form-check-label" for="jenis_wajib">Wajib</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis" id="jenis_pilihan" value="Pilihan" {{ old('jenis') == 'Pilihan' ? 'checked' : '' }}>
