...
<div class="page-title">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('kaprodi.dosen.index') }}">Dosen</a></li>
...
<div class="row">
    <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-body">
                <a href="{{ route('kaprodi.dosen.index') }}" class="btn btn-outline-secondary w-100">
                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $mhs->nim }}</td>
                                <td>
                                    @if($mhs->program_studi_id == $prodi->id)
                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($ta->mahasiswa && $ta->mahasiswa->program_studi_id == $prodi->id)
                                        <a href="{{ route('kaprodi.tugas-akhir.show', $ta) }}" title="{{ $ta->judul }}">
                                            {{ Str::limit($ta->judul, 40) }}
                                        </a>
                                    @else
                                        <span title="{{ $ta->judul }}">{{ Str::limit($ta->judul, 40) }}</span>
                                    @endif
                                </td>
                                <td>
