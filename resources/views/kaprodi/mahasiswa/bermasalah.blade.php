...
<div class="page-title">
    <h4>Mahasiswa Bermasalah</h4>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('kaprodi.dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Mahasiswa Bermasalah</li>
        </ol>
    </nav>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="text-center text-muted py-3">Tidak ada mahasiswa dengan IPK rendah</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center text-muted py-3">Tidak ada mahasiswa cuti</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center text-muted py-3">Tidak ada mahasiswa tidak aktif</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
