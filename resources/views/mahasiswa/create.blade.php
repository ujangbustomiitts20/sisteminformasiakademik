                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="nik" class="form-control" value="{{ old('nik') }}" maxlength="16" placeholder="16 digit">
                            <small class="text-muted">Nomor Induk Kependudukan</small>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">No. Kartu Keluarga</label>
                            <input type="text" name="no_kk" class="form-control" value="{{ old('no_kk') }}" maxlength="16">
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="provinsi_id" id="provinsi_id" class="form-select" data-current="{{ old('provinsi_id') }}">
                                <option value="">-- Pilih Provinsi --</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Kabupaten/Kota</label>
                            <select name="kabupaten_id" id="kabupaten_id" class="form-select" data-current="{{ old('kabupaten_id') }}" disabled>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="kecamatan_id" id="kecamatan_id" class="form-select" data-current="{{ old('kecamatan_id') }}" disabled>
                                <option value="">-- Pilih Kecamatan --</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Kelurahan/Desa</label>
                            <select name="kelurahan_id" id="kelurahan_id" class="form-select" data-current="{{ old('kelurahan_id') }}" disabled>
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" name="rt" class="form-control" value="{{ old('rt') }}" maxlength="5" placeholder="001">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label class="form-label">RW</label>
                            <input type="text" name="rw" class="form-control" value="{{ old('rw') }}" maxlength="5" placeholder="001">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label class="form-label">Kode Pos</label>
                            <input type="text" name="kode_pos" id="kode_pos" class="form-control" value="{{ old('kode_pos') }}" maxlength="10">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Alamat (Jalan/Dusun/dll)</label>
                            <input type="text" name="alamat" class="form-control" value="{{ old('alamat') }}" placeholder="Jl. Contoh No. 123">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="program_studi_id" id="program_studi_id" class="form-select @error('program_studi_id') is-invalid @enderror" required>
                                ...
                                <option value="{{ $ps->id }}" data-kode="{{ $ps->kode }}" data-fakultas="{{ $ps->fakultas->kode ?? '' }}" {{ old('program_studi_id') == $ps->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="jalur_masuk" class="form-select">
                                ...
                                <option value="{{ $jalur }}" {{ old('jalur_masuk') == $jalur ? 'selected' : '' }}>{{ $jalur }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="asal_sekolah" id="asal_sekolah_manual" class="form-control" value="{{ old('asal_sekolah') }}" placeholder="Jika tidak ada di daftar">
                            <small class="text-muted">Isi jika sekolah tidak ada di daftar</small>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Jurusan Asal</label>
                            <input type="text" name="jurusan_asal" class="form-control" value="{{ old('jurusan_asal') }}" placeholder="IPA/IPS/Teknik dll">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Tahun Lulus</label>
                            <input type="number" name="tahun_lulus_sekolah" class="form-control" value="{{ old('tahun_lulus_sekolah') }}" min="1990" max="{{ date('Y') }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">No. Ijazah SMA</label>
                            <input type="text" name="no_ijazah_sma" class="form-control" value="{{ old('no_ijazah_sma') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Nilai UN</label>
                            <input type="number" name="nilai_un" class="form-control" value="{{ old('nilai_un') }}" step="0.01" min="0" max="100">
                        </div>
                    </div>
                    ...
                    <div class="card bg-light border-0 mt-3">
                        <div class="card-body">
                            <h6 class="card-title mb-3">
                                <i class="bi bi-eye me-2"></i>Preview NIM & Email
                            </h6>
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="form-label small text-muted">NIM (Otomatis)</label>
                                    <div class="input-group">
                                        <input type="text" id="preview_nim" class="form-control form-control-sm bg-white" readonly placeholder="Pilih Program Studi">
                                        <button type="button" class="btn btn-sm btn-outline-secondary" id="btn_refresh_nim" title="Refresh NIM" disabled>
                                            <i class="bi bi-arrow-clockwise"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small text-muted">Email (Otomatis)</label>
                                    <input type="text" id="preview_email" class="form-control form-control-sm bg-white" readonly placeholder="Pilih Program Studi">
                                </div>
                            </div>
                            <small class="text-muted d-block mt-2">
                                <i class="bi bi-info-circle me-1"></i>
                                Format NIM: [Kode Fakultas][Kode Prodi][Bulan][Tahun][Nomor Urut]. Password default = NIM
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="email" name="email_ortu" class="form-control" value="{{ old('email_ortu') }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="penghasilan_ortu" class="form-select">
                                ...
                                <option value="{{ $penghasilan }}" {{ old('penghasilan_ortu') == $penghasilan ? 'selected' : '' }}>{{ $penghasilan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Provinsi</label>
                            <select name="provinsi_ortu_id" id="provinsi_ortu_id" class="form-select" data-current="{{ old('provinsi_ortu_id') }}">
                                <option value="">-- Pilih Provinsi --</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Kabupaten/Kota</label>
                            <select name="kabupaten_ortu_id" id="kabupaten_ortu_id" class="form-select" data-current="{{ old('kabupaten_ortu_id') }}" disabled>
                                <option value="">-- Pilih Kabupaten --</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Kecamatan</label>
                            <select name="kecamatan_ortu_id" id="kecamatan_ortu_id" class="form-select" data-current="{{ old('kecamatan_ortu_id') }}" disabled>
                                <option value="">-- Pilih Kecamatan --</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Kelurahan/Desa</label>
                            <select name="kelurahan_ortu_id" id="kelurahan_ortu_id" class="form-select" data-current="{{ old('kelurahan_ortu_id') }}" disabled>
                                <option value="">-- Pilih Kelurahan --</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="hubungan_wali" class="form-select">
                                ...
                                <option value="{{ $hub }}" {{ old('hubungan_wali') == $hub ? 'selected' : '' }}>{{ $hub }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="atas_nama_rekening" class="form-control" value="{{ old('atas_nama_rekening') }}">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3" id="kip_container" style="{{ old('penerima_kip') == '1' ? '' : 'display: none;' }}">
                            <label class="form-label">No. KIP</label>
                            <input type="text" name="no_kip" class="form-control" value="{{ old('no_kip') }}" placeholder="Nomor Kartu Indonesia Pintar">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Format: JPG, PNG. Maks: 2MB. Ukuran: 3x4</small>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="alert alert-info mb-3">
                        ...
                        <strong>Info:</strong> NIM dan Email akan dibuat otomatis. Password default adalah NIM mahasiswa.
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const previewNim = document.getElementById('preview_nim');
    const previewEmail = document.getElementById('preview_email');
    const btnRefresh = document.getElementById('btn_refresh_nim');
    ...
    function generateNim() {
        ...
        previewNim.value = 'Memuat...';
        previewEmail.value = 'Memuat...';

        fetch('{{ route("mahasiswa.generate-nim") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
            body: JSON.stringify({ program_studi_id: prodiId })
        })
        .then(response => response.json())
        .then(data => {
            if (data.success) {
                previewNim.value = data.nim;
                previewEmail.value = data.email;
            } else {
                previewNim.value = 'Error';
                previewEmail.value = 'Error';
            }
        })
        .catch(error => {
    ...
    prodiSelect.addEventListener('change', generateNim);
    btnRefresh.addEventListener('click', generateNim);
