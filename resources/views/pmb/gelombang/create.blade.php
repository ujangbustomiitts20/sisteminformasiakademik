...
@section('title', 'Tambah Gelombang PMB')

@section('content')
<div class="container-fluid">
    <div class="mb-4">
        <h1 class="h3 mb-0">Tambah Gelombang PMB</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('pmb.gelombang.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('periode_pmb_id') is-invalid @enderror" id="periode_pmb_id" name="periode_pmb_id" required>
                            ...
                            @foreach($periodes as $periode)
                                <option value="{{ $periode->id }}" {{ old('periode_pmb_id') == $periode->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control @error('nomor_gelombang') is-invalid @enderror" 
                               id="nomor_gelombang" name="nomor_gelombang" value="{{ old('nomor_gelombang', 1) }}" min="1" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_mulai_daftar') is-invalid @enderror" 
                               id="tanggal_mulai_daftar" name="tanggal_mulai_daftar" value="{{ old('tanggal_mulai_daftar') }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_selesai_daftar') is-invalid @enderror" 
                               id="tanggal_selesai_daftar" name="tanggal_selesai_daftar" value="{{ old('tanggal_selesai_daftar') }}" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_pengumuman') is-invalid @enderror" 
                               id="tanggal_pengumuman" name="tanggal_pengumuman" value="{{ old('tanggal_pengumuman') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_daftar_ulang_mulai') is-invalid @enderror" 
                               id="tanggal_daftar_ulang_mulai" name="tanggal_daftar_ulang_mulai" value="{{ old('tanggal_daftar_ulang_mulai') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_daftar_ulang_selesai') is-invalid @enderror" 
                               id="tanggal_daftar_ulang_selesai" name="tanggal_daftar_ulang_selesai" value="{{ old('tanggal_daftar_ulang_selesai') }}">
