...
$deleted = App\Models\PengajuanSurat::where('mahasiswa_id', $mahasiswa->id)->delete();
if ($deleted > 0) {
    echo "🗑️  Menghapus {$deleted} data lama..." . PHP_EOL . PHP_EOL;
}
...
echo PHP_EOL . "🌐 Akses Fitur:" . PHP_EOL;
...
echo "   Mahasiswa: rina.wibowo1@student.siakad.ac.id / 2024004001" . PHP_EOL;
echo "   Admin    : admin@siakad.ac.id / password" . PHP_EOL;
